import sys
import breeze as Breeze
tmp_breeze = Breeze.Breeze(0)
breeze = tmp_breeze.breeze
import datetime
import pandas as pd
import numpy as np
import time
...
# data = get_equity_historical_data(start_date=(date) + "T09:15:00.000Z", end_date=(date) + "T10:30:00.000Z", stock_code="CNXBAN", time_interval="1second")
# print(data)
